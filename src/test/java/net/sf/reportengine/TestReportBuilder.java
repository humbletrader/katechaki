...
public class TestReportBuilder {
    ...
    public void testBuild() {
        ...
        Assert.assertTrue(new ReportBuilder(new PdfReportOutput(null)).build() instanceof PostProcessedFoReport);
        Assert.assertTrue(new ReportBuilder(new TiffReportOutput(null)).build() instanceof PostProcessedFoReport);
